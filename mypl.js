...
var grammar = {
    ...
    {"name": "print_statement", "symbols": ["print_statement$string$1", {"literal":"("}, "expression", {"literal":")"}], "postprocess": 
        data => {
            return {
    ...
    {"name": "identifier$ebnf$2", "symbols": [/[A-Z]/]},
    {"name": "identifier$ebnf$2", "symbols": ["identifier$ebnf$2", /[A-Z]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "identifier", "symbols": ["identifier$ebnf$2"], "postprocess": id},
